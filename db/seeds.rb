...
janice.create_user(:email => 'janicemin@gmail.com', :password => 'topsecret', :password_confirmation => 'topsecret')
elliott.create_user(:email => 'elliott@example.com', :password => 'topsecret', :password_confirmation => 'topsecret')


janice.closet.update_attribute(:name, "Janice's Closet")
elliott.closet.update_attribute(:name, "Elliott's Closet")


janice.closet.garments.create!([
...
elliott.closet.garments.create!([
